...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Mar 2017 pada 07.56
...
(1, 11110, 3, 'Sigit kushananto', 'sigit@gmail.com', '121212', NULL, '0858454545455', 'M'),
(2, 11110, 5, 'fajar', '', '', 'kp. rambutan', '08781356565', 'M'),
(3, 11110, 4, 'dewi ratna sari', '', '', '', '801325262626', 'F'),
(4, 11110, 2, 'adam', '', '', 'jl. salemba', '021 4613891', 'M'),
(5, 11110, 4, 'jaka ardiola', '', '', '', '0788123451617', 'M');
...
(4, 1002, 11118, 'Anggur', 2000, 100),
(5, 1003, 11118, 'Anggur Merah', 11600, 300),
(6, 1003, 11118, 'Alpukat', 105000, 750),
(7, 1002, 11118, 'Alpukat', 700000, 800),
(8, 1003, 11118, 'strawberry', 50000, 1200),
(9, 1003, 11118, 'jeruk medan', 150000, 1900),
(11, 1003, 11118, 'jeruk pontianak', 80000, 1700);
...
(6, 112, 11110, 'Hotel Grand Tjokro', 'grandtjokro@gmail.com', '021 3458733', 'daan mogot', '2017-03-21'),
(7, 112, 11110, 'Hotel Harris', 'hariskg@gmail.com', '021 4638791', 'kelapa gading', '2017-03-21'),
(8, 112, 11110, 'Solaria', 'solaria@admin.com', '087881925314', 'mall la piazza kelapa gading', '2017-03-21'),
(9, 111, 11110, 'petani bogor', 'petanibgr@yahoo.com', '081953162344', 'bogor', '2017-03-21'),
(10, 111, 11110, 'petani bandung', 'petanibandung@yahoo.com', '087813353121', 'bandung', '2017-03-21');
...
--
ALTER TABLE `posisi`
  MODIFY `idposisi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `trxdetail`
  MODIFY `idtrxdetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `trxretur`
--
ALTER TABLE `trxretur`
  MODIFY `idtrxretur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
